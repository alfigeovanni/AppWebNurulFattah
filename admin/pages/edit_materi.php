...
<?php include("partial/navbar.php") ?>
        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header">
              <h6>Data Materi</h6>
              <a class="btn btn-info" href="materi.php"> Kembali </a>
              <!-- <div class="mb-3">
    ...
    $materi = $_POST['materi'];
      ...
      $sql = "UPDATE tb_materi SET nama_materi='$materi' WHERE id_materi=".$_POST['id_materi'];
      if ($kon->query($sql) === TRUE) {
         ...
         echo "Gagal: " . $kon->error;
      }
      $kon->close();	
}else{
      $query = $kon->query("SELECT * FROM tb_materi WHERE id_materi=".$_GET['id']);
      if($query->num_rows > 0){
...
?>
      ...
      <form class=" row" action="edit_materi.php"  method="POST">
        <div class="col-md-2">
          <label for="exampleFormControlInput1">Nama Materi</label>
        </div>
        <div class="col-md-5">
          <input type="hidden" name="id_materi" value="<?= $data->id_materi ?>">
          <input name="materi" type="text" value="<?= $data->nama_materi ?>" class="form-control" id="exampleFormControlInput1" placeholder="Nama Materi">
        </div>
        <div class="col-md-3">
          <button type="submit" name="tambah" class="btn btn-primary mb-3">Edit</button>
        </div>
      </form>
