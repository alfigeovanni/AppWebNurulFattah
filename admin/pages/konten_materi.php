...
<h4 class="modal-title">File Materi</h4>
...
<?php include("partial/navbar.php") ?>
    ...
    <div class="container-fluid py-4">
        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header">
              <h6>Data Konten Materi</h6>
              <a class="btn btn-primary" href="tambah_konten_materi.php"> Tambah Konten Materi </a>
              <!-- <div class="mb-3">
      ...
      <?php
      $sql = 'SELECT a.*, b.nama_materi, c.* FROM tb_sub_materi as a inner join tb_materi as b on b.id_materi = a.id_materi inner join tb_konten_sub_materi as c on c.id_sub_materi=a.id_sub_materi';
                ...
                <table id="example" class="table align-items-center text-center">
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary">Kat Materi</th>
                      <th class="text-uppercase text-secondary">Materi</th>
                      <th class="text-uppercase text-secondary">Nama Konten Materi</th>
                      <th class="text-uppercase text-secondary">File Materi</th>
                  ...
                  <tbody>
                    ...
                    <tr >
                      ...
                      <td>
                        <a class="clickLink" data-bs-toggle="modal" data-bs-target="#myModal" data-id="<?= $qr['file_konten_materi'] ?>">Lihat File</a>
                      </td>
                      <td>
                      
                      <a class="btn btn-info" href="edit_konten_materi.php?id=<?= $qr['id_konten_sub_materi'] ?>"><i class="bi bi-pencil-square"></i></a>
                      <a onclick="return confirm('Apakah yakin data akan di hapus?')" href="del_konten_materi.php?id=<?=$qr['id_konten_sub_materi']?>&file=<?=$qr['file_konten_materi']?>" class="btn btn-danger"><i class="bi bi-trash-fill"></i></a>
