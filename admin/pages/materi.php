...
<?php include("partial/navbar.php") ?>
    ...
    <div class="container-fluid py-4">
        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header">
              <h6>Data Materi</h6>
              <a class="btn btn-primary" href="tambah_materi.php"> Tambah Materi </a>
              <!-- <div class="mb-3">
      ...
      <?php
      $sql = 'SELECT id_materi, nama_materi FROM tb_materi';
                ...
                <table id="example" class="table align-items-center text-center">
                  ...
                  <tbody>
                    ...
                    <tr >
                      ...
                      <a class="btn btn-info" href="edit_materi.php?id=<?= $qr['id_materi'] ?>"><i class="bi bi-pencil-square"></i></a>
                      <a onclick="return confirm('Apakah yakin data akan di hapus?')" href="del_materi.php?id=<?=$qr['id_materi']?>" class="btn btn-danger"><i class="bi bi-trash-fill"></i></a>
