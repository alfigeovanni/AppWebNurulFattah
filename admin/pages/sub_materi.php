...
<?php include("partial/navbar.php") ?>
    ...
    <div class="container-fluid py-4">
        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header">
              <h6>Data Isi Materi</h6>
              <a class="btn btn-primary" href="tambah_sub_materi.php"> Tambah Isi Materi </a>
              <!-- <div class="mb-3">
      ...
      <?php
      $sql = 'SELECT a.*, b.nama_materi FROM tb_sub_materi as a inner join tb_materi as b on b.id_materi = a.id_materi';
                ...
                <table id="example" class="table align-items-center text-center">
                  ...
                  <tbody>
                    ...
                    <tr >
                      ...
                      <a class="btn btn-info" href="edit_sub_materi.php?id=<?= $qr['id_sub_materi'] ?>"><i class="bi bi-pencil-square"></i></a>
                      <a onclick="return confirm('Apakah yakin data akan di hapus?')" href="del_sub_materi.php?id=<?=$qr['id_sub_materi']?>" class="btn btn-danger"><i class="bi bi-trash-fill"></i></a>
